...
def Panoptes4(inputa, inputb, inputc, demographics=None,
               dropout=0.8, num_cls=1000, is_train=True, scope='Panoptes4', supermd=False):
    with tf.variable_scope(scope, 'Panoptes4', [inputa, inputb, inputc]):
